...
//    meter of carpet. For example, the area of the floor that is 12 meters long and 10 meters wide is 120 square meters.
//    To cover the floor with a carpet that costs $8 per square meter would cost $960.
//
//    1. Write a class with the name Floor. The class needs two fields (instance variables) with name width and length
//    of type double.
