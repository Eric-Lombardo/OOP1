...
//    The class needs to have one constructor with three parameters width, length, and height all of type double. It
//    needs to call parent constructor and initialize a height field.
